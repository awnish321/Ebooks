...
public class My_Downloads_EBookList extends Activity{
     	 ...
     	 public void onCreate(Bundle savedInstanceState) {
             ...
             // get Internet status
				...
				if (isInternetPresent) {
					MyDownloadsList();
						String message = "Please Wait....";
			 			dialog = new ProgressHUD(My_Downloads_EBookList.this, com.radaee.viewlib.R.style.AppTheme);
			 			dialog.setTitle("");
    		        ...
    		        public void onResponse(String response) {
    		            ...
    		            try {
    						...
    						for (int i = 0; i < array.length(); i++) {
    			                ...
    			                GridViewAdapterBooksDownload adapter = new GridViewAdapterBooksDownload(My_Downloads_EBookList.this,vinarrayList );
    			                gv_subcat.setAdapter(adapter);
    							}else
    			        		 {
    			        			 final Dialog dialoga = new Dialog(My_Downloads_EBookList.this);
    									dialoga.requestWindowFeature(Window.FEATURE_NO_TITLE);
    									...
    									dialogButton.setOnClickListener(new OnClickListener() {
    										...
    										public void onClick(View v) {
    											dialoga.dismiss();
    											My_Downloads_EBookList.this.finish();
    											startActivity(new Intent(My_Downloads_EBookList.this, Dashboard.class));
    										}
    									});
    									dialoga.show();
    			        		 }
