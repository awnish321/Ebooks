...
import com.rachnasagar.adapter.GridViewAdapterIBooksDownload;
...
public class My_Downloads_Intra_EBookList extends Activity{
    ...
    ArrayList<VinSetterGetter> iEbookList = new ArrayList<VinSetterGetter>();
...
//                            vinarrayList = new ArrayList<VinSetterGetter>();
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                if (dialog.isShowing())
                                    dialog.dismiss();
                                GridViewAdapterIBooksDownload adapter = new GridViewAdapterIBooksDownload(My_Downloads_Intra_EBookList.this,iEbookList );
