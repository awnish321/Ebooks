...
public class PdfIActivity extends AppCompatActivity {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                if (file_details.exists()) {
                                    if (first.contentEquals("value1")) {
                                        ...
                                        preferences = getSharedPreferences("BookDownloadDetailI", Context.MODE_PRIVATE);
...
//            progressBar.setVisibility(View.VISIBLE);
    ...
    private void ebookDownLoadFile(){
        ...
        isInternetPresent = cd.isConnectingToInternet();
        if (isInternetPresent) {
            PdfIActivity.DownloadMapAsync mew = new PdfIActivity.DownloadMapAsync();
