	 ...
	 // flag for Internet connection status
				    ...
				    public void onCreate(Bundle savedInstanceState) {
				    	...
				    	this.requestWindowFeature(Window.FEATURE_NO_TITLE);
 	        			...
 	        			// creating connection detector class instance
 	  					...
 	  					fetch=getIntent();
 	  					first=fetch.getStringExtra("key1");
 	  					Log.d("roman0",first);
		...
		public  void deleteDir(File dir) throws IOException {
			    if (!dir.isDirectory()) {
				  ...
				  Log.e("filed",""+dir);
				  Log.d("listfiles55",""+ dir);
			    File[] files = dir.listFiles();
			    Log.d("listfiles",""+ dir.listFiles());
			      ...
			      if (file.isDirectory()) {
			        ...
			        //Toast.makeText(getApplicationContext(), " File Deleted. ", Toast.LENGTH_SHORT).show();
					 // checkimage.setVisibility(View.GONE);
					  ...
					  System.out.println("dhokhaaaaa"+"     "+file+"     "+dir);
			      }
			      else {
					  Log.d("deleted121","8888");
			        boolean deleted = file.delete();
			        Log.d("deleted121",""+deleted);
			        if (!deleted) {
